...
Un hiperparámetro $\Lambda_i$ puede tener un dominio de valores continuos, discretos, booleanos o catergóricos. [poner ejemplos]. 
...
\subsection{Métodos de Optimización}\label{subsec:automl_methods}
...
BO es un algoritmo iterativo, cuya idea clave es modelar el mapeo entre un conjunto de hiperparámetros $\lambda$ y da como resultado una estimación de su rendimiento $\hat{c}(\lambda)$ ($\lambda \rightarrow \hat{c}(\lambda)$) basado en
