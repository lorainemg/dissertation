...
En la primera fase el objetivo es identificar un subconjunto de algoritmos de aprendizaje de máquinas adecuados basados en un dataset de entrada. El método de selección usado en ese proceso se basa en el meta-conocimiento. Por lo general el resultado de esta fase es representado en la forma de un subconjunto rankeado de algortimos de aprendizaje de máquinas.
